...
export const AutoResizeTextarea = ({
  ...
  const updateTextareaSize = () => {
    ...
    const computedLineHeight =
      Number.parseInt(textareaStyles.lineHeight) || Number.parseInt(textareaStyles.fontSize) * 1.2 || 24
    const newHeight = Math.max(lineCount * computedLineHeight, minRows * computedLineHeight)
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={hiddenDivRef}
        className="absolute top-0 left-0 -z-10 invisible border border-transparent"
        style={{
          padding: "0px",
          overflowWrap: "normal",
          whiteSpace: "pre",
